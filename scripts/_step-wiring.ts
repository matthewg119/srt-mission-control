...
const COMMANDS: Record<string, string[]> = {
  ...
  keyword_set: [
    ...
    "`keywords variations`",
    "`keywords delete all` + [Yes, delete all N]",
    "`keywords shortlist`",
    "paste a Google screenshot, no caption (`keywords serp N` overrides)",
    "✅ / ❌ / 🔁 on a keyword's card",
    "`keywords serp N: <verdict>`, `magnet N: <what we give away>`",
    "`serp cards`",
    "`strategy`, `strategy new`, `strategy approve`",
    "`strategy merge N under M`, `strategy pillar N`, `strategy service|post N`",
  ],
