# Meta Glasses POV - spraying indoors

| | |
|---|---|
| id | `pest_control__pov__spray_indoor` |
| avatar | pest_control |
| category | pov / spray_indoor |
...
| editor | https://mission.srtagency.com/dashboard/content-workflows/pest_control__pov__spray_indoor |
...
### Shot 1 — spot the activity indoors
- image_prompt: First-person POV through Meta glasses crouched at a kitchen baseboard, ants trailing along the caulk line toward the pantry, gloved hand pointing
- animation: Slow push in along the baseboard following the trail.
- duration: 4s

### Shot 2 — treat the baseboards
- image_prompt: First-person POV running a precision spray wand along the kitchen baseboard, fine mist visible, tile floor and cabinet kicks in frame
- animation: Steady lateral glide as the wand tracks the baseboard.
- duration: 4s

### Shot 3 — clean kitchen result
- image_prompt: First-person POV of the same spotless kitchen baseboard, no insects, morning light across the tile
- animation: Slow settle on the clean line, slight tilt up to the counter.
- duration: 4s
...
Edit name / description / visual rules / scene prompts / image settings at https://mission.srtagency.com/dashboard/content-workflows/pest_control__pov__spray_indoor.
