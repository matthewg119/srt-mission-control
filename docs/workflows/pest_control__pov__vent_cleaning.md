# Meta Glasses POV - vent cleaning
...
| editor | https://mission.srtagency.com/dashboard/content-workflows/pest_control__pov__vent_cleaning |
...
### Shot 1 — the blocked vent
- image_prompt: First-person POV unscrewing a dusty wall vent cover, matted debris and nesting material packed behind the grille
- animation: Cover comes away revealing the packed debris.
- duration: 4s

### Shot 2 — the clean-out
- image_prompt: First-person POV vacuum hose pulling debris out of the duct, gloved hand steadying the hose, dust in the light beam
- animation: Hose works deeper, debris streaming out.
- duration: 4s

### Shot 3 — clean airflow
- image_prompt: First-person POV of the reinstalled shining vent cover, a ribbon held up fluttering in the strong clean airflow
- animation: Ribbon lifts and flutters as the airflow hits.
- duration: 4s
...
Edit name / description / visual rules / scene prompts / image settings at https://mission.srtagency.com/dashboard/content-workflows/pest_control__pov__vent_cleaning.
