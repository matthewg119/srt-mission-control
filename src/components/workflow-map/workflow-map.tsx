...
export function WorkflowMap({ stats }: WorkflowMapProps) {
  ...
  const nodes: Node[] = useMemo(() => [
    ...
    { id: "cf4", type: "flowNode", position: { x: X1 + 50, y: 330 }, data: { label: "GHL Contact Created", sub: "Contact + opportunity", type: "action" } },
    ...
    { id: "af4", type: "flowNode", position: { x: X2 + 50, y: 330 }, data: { label: "GHL Contact Created", sub: "Tag: application-started", type: "action" } },
    ...
    { id: "af7", type: "flowNode", position: { x: X2, y: 690 }, data: { label: "PDF + Signature", sub: "Generated & uploaded to GHL", type: "action" } },
    ...
    { id: "sa1", type: "flowNode", position: { x: X3, y: 90 }, data: { label: "GHL Stage Change", sub: "Webhook or manual move", type: "trigger" } },
    ...
    { id: "sp4", type: "flowNode", position: { x: X4, y: 450 }, data: { label: "ghl.sendEmail()", sub: "Deliver via GHL", type: "action", count: stats.emailSent, countLabel: "sent (7d)" } },
