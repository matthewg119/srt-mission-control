...
const PEST_6HL_PROPAGANDA: Workflow = {
  ...
  captions: [
    ...
    { text: "Homeowners already know who to call and is not you", at_second: 4.04 },
  ...
  copy_structure: [
    { key: "avatar", label: "Avatar", guidance: "Name who this is for.", shot: 1, at_second: 0.0, out_second: 4.04, position: "upper_side" },
    { key: "pain_callout", label: "Pain callout", guidance: "One-line pain that stops the scroll.", shot: 1, at_second: 0.03, out_second: 4.04, position: "upper_middle" },
    { key: "cost_pain", label: "Increase pain / cost", guidance: "What the pain is costing them.", shot: 1, at_second: 2.04, out_second: 4.04, position: "upper_middle" },
    { key: "category_pain", label: "Increase pain / category", guidance: "Twist the knife, make it personal.", shot: 2, at_second: 4.04, out_second: 8.02, position: "upper_middle" },
  ...
  render_spec: {
    ...
    shots: [
      { i: 1, start: 0.0, end: 4.04 },
      { i: 2, start: 4.04, end: 8.02 },
      { i: 3, start: 8.02, end: 11.3 },
    ],
    texts: [
      { n: 1, text: "Pest control Owners", at_second: 0.0, out_second: 4.04, position: "upper_side", role: "avatar", pop: false },
      { n: 2, text: "Your slow season, is somebody elses high season", at_second: 0.03, out_second: 4.04, position: "upper_middle", role: "pain_callout", pop: true },
      { n: 3, text: "Ignorance is costing you a fortune every year.", at_second: 2.04, out_second: 4.04, position: "upper_middle", role: "cost_pain", pop: true },
      { n: 4, text: "Homeowners already know who to call and is not you", at_second: 4.04, out_second: 8.02, position: "upper_middle", role: "category_pain", pop: false },
