...
const MEDSPA_OWNER_AI: Vertical = {
  ...
  visual_rules: [
    ...
    "Real places and real objects, lived in rather than styled: a towel not quite square, a cable, a bottle set down where it was used. But this clinic is CLEAN - grime, scuffs and neglect are not realism here, they are the wrong business. A staged, perfectly symmetrical room reads as a render; a dirty one reads as a failing clinic.",
    "Every frame is BRIGHT: white or warm-neutral walls, daylight or clean clinical light, open shadows, the room reading as lit. Never dark, dim, underlit, gloomy or shot after hours. The reference is the way a real med spa photographs itself, and it is the rule the drops of 2026-08-27 broke.",
    ...
    "THE HERO FRAME - scene 1 of a Hook Studio video, and idea 1 of every daily b-roll drop - IS her client mid-treatment: botox, HIFU, filler or laser hair removal, or a spa ritual (a clay mask, cucumber slices over closed eyes, a hot towel, a facial massage, an LED mask), shot from an angle and never graphic. It is the one shot where a real patient and practitioner may be identifiable, and the one shot that is clean, bright and aspirational rather than documentary. Its subject is dealt in code, not chosen here.",
