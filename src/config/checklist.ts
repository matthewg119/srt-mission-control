    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "mc-pk-07", label: "Supabase updates when deal moved", priority: "high" },
      ...
      },
      {
        ...
        title: "Integrations",
        items: [
          { id: "mc-in-01", label: "Zoho CRM shows Connected", priority: "critical" },
          { id: "mc-in-02", label: "Microsoft 365 shows connected status", priority: "critical" },
          { id: "mc-in-03", label: "Zoho sync verified", priority: "high" },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "api-lc-03", label: "Creates Supabase contact + Zoho lead", priority: "critical" },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "api-app-04", label: "100%: final enrichment + PDF gen + OneDrive + Zoho sync", priority: "critical" },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "api-fu-04", label: "Attaches files to Zoho lead", priority: "high" },
    ...
    sections: [
      {
        ...
        title: "Zoho CRM",
        items: [
          { id: "int-zoho-01", label: "OAuth refresh token authenticates successfully", priority: "critical" },
          { id: "int-zoho-02", label: "Can create/update leads", priority: "critical" },
          { id: "int-zoho-03", label: "Can search leads by email", priority: "high" },
          { id: "int-zoho-04", label: "Can attach PDF to lead", priority: "high" },
          { id: "int-zoho-05", label: "Custom fields mapped correctly", priority: "high" },
        ],
      },
      {
        id: "ms365",
    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "cf-07", label: "PDF attached to Zoho lead", priority: "high" },
          { id: "cf-08", label: "Tag \"application-completed\" added to contact", priority: "high" },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "db-09", label: "deals table has proper indexes", priority: "high" },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "fin-17", label: "Check Zoho lead for documents + tag", priority: "high" },
        ],
      },
    ],
  },
