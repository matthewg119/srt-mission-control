...
## Read before touching the onboarding board
- **`docs/DATA-AND-WORKFLOWS.md`** — the doctrine, the workflows people type, where the data lives,
  and the measured list of what is still dropped on the floor. Hand-written, read this first.
- `docs/ONBOARDING-MAP.md` + `docs/STEP-WIRING.md` — generated by `scripts/_step-wiring.ts`.
  Never hand-edit; regenerate and run `--check`.
